...
const styles = {
  ...
  filterTabs: {
    display: 'flex',
    backgroundColor: 'var(--hj-color-surface-muted)',
    borderRadius: '8px',
    padding: '4px',
    gap: '4px',
  },
  tab: (active) => ({
    ...
    color: active ? 'var(--hj-color-ink)' : 'var(--hj-color-ink-subtle)',
  ...
  listItem: (isDraft) => ({
    ...
    padding: '16px',
    marginBottom: '12px',
    backgroundColor: isDraft ? 'var(--hj-color-surface-muted)' : 'white',
    opacity: isDraft ? 0.85 : 1,
    borderLeft: isDraft ? '4px solid var(--hj-color-ink-subtle)' : '1px solid var(--hj-color-border-subtle)',
  }),
  badge: (severity) => {
